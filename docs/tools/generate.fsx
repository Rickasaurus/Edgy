...
let githubLink = "http://github.com/Rickasaurus/Edgy"

// Specify more information about your project
let info =
  [ "project-name", "Edgy"
    "project-author", "Rick Minerich"
    "project-summary", "A library to make working with graphs easy in F#"
    "project-github", githubLink
    "project-nuget", "http://nuget.org/packages/Edgy" ]
